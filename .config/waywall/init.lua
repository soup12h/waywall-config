...
-- == config variables ==
local normal_sens, tall_sens = 15.29, 1.07935043
...
local keybinds = {
    enabled = {
        ...
        -- swap back later (home on mb4, rework binds)
...
for i = 0, 3, 1 do
    ...
    helpers.res_mirror({
            src = { x = 1827, y = 859 + 8 * i, w = 33, h = 9 },
            dst = { x = 1630 + 7, y = 720 + 7, w = 33 * 7, h = 9 * 7 },
            depth = 2,
            shader = "spawn_bg",},
        0, 0
    )
